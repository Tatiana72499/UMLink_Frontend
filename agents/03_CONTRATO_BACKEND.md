...
- Una relación puede conectar una clase consigo misma para modelar una relación recursiva. La clase intermedia se mantiene exclusivamente para asociaciones entre dos clases diferentes.
